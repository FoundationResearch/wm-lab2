...
# Use the first letter of RUN_WORD to namespace output dirs (e.g., alpha -> aj1/aj2/aj3).
...
python data_collector.py \
  ...
  --run_name "${RUN_WORD} jumpf1" 2>&1 | tee -a "logs/overnight/${EXP_NAME}_${RUN_TAG}1.log"
...
python data_collector.py \
  ...
  --run_name "${RUN_WORD} jumpf2" 2>&1 | tee -a "logs/overnight/${EXP_NAME}_${RUN_TAG}2.log"
...
python data_collector.py \
  ...
  --run_name "${RUN_WORD} jumpf3" 2>&1 | tee -a "logs/overnight/${EXP_NAME}_${RUN_TAG}3.log"
